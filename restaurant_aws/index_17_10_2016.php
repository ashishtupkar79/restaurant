...
<?php include 'analyticstracking.php'; ?>
  ...
  <div id="callers" align="center"><b>Call Now</b> <br> <a href="tel://07126600288" class="phone" style="color:#fff"><i class="icon-phone-circled"></i>  0712 - 6600288&nbsp;&nbsp</a><br><a href="tel://917378845457" class="phone" style="color:#fff"><i class="icon-phone-circled"></i>  +91 7378845457</a></div> 
    ...
    <!-- Content ================================================== -->
		...
		<div class="row">
          ...
          <div class="col-md-3">
			...
			<div class="col-md-3">
               <a href="0" data-toggle="modal" data-target="#terms1"  id="tenth_order_2a"> <div class="box_home" id="one" style="background: #fff url('offers_img/4.jpg') no-repeat scroll center 10px;">
                    <span>4</span>
                    <h3>&nbsp;</h3>
                    <p>
                        &nbsp;
            ...
            <div class="col-md-6">
                ...
                <div class="ribbon_1">Popular</div>
                    <div class="desc">
                        ...
                        <h3>Paneer Tikka</h3>
                        <div class="type">
                           Veg <span class="opening" style="font-style:normal;margin-left:100px;"><b><i class="fa fa-inr"></i> 200</b></span>
                        </div>
                        <div class="location">
						...
						<div style="float:right">
						<br><input type="submit" class="button_intro2" name="confirm_pwd" id="confirm_pwd"  value="Add to Cart" style="cursor:pointer"  onclick="cart('51','add')" style="cursor:pointer">	
						</div>
                    </div><!-- End desc-->
                </a><!-- End strip_list-->
            </div>
