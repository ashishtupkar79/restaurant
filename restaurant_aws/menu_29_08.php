        ...
        <div class="row">
           ...
           <!-- <div class="col--md-4 col-sm-4 col-xs-4">
			...
			<div class="col--md-4 col-sm-4 col-xs-4">
				...
				<?php 
						/*echo '<a id="show_cart" class="hidden-lg hidden-md hidden-sm">';
						$sid = session_id();
                 ...
                 <ul>
					...
					<?php
							...
							else
							{
								...
								//echo  '<li><a href="#0" data-target="#register" data-toggle="modal" id="register_2a">Register</a>';
							}
					?>
