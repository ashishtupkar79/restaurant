						...
						<div class="box_style_2" id="order_process" style="border:0px;padding-top: 0;">
							...
							<div class="col-md-6" style="box-shadow: 0 0 5px 0 rgba(0, 0, 0, 0.1);">				
								<div class="box_style_2" id="order_process2" style="border:0px;padding-top: 0;">
									...
									<div class="form-group">
										<input type="text" id="mob_order" name="mob_order" class="form-control" placeholder="Mobile number for SMS Confirmation" required="" digits="true" data-rule-required="true" data-msg-required="Please enter 10 digits mobile number" minlength="10" maxlength="10"  value="<?php echo @$mobile_number; ?>">
									</div>
									<div class="form-group">
