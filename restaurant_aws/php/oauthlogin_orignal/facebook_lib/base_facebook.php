...
abstract class BaseFacebook
{
  ...
  protected function getCurrentUrl() {
	...
	//$currentUrl = 'http://localhost:81/php/oauthlogin_orignal/facebook_login.php';
	$currentUrl = 'https://www.zaikart.com/php/oauthlogin_orignal/facebook_login.php';
//	$currentUrl = 'https://emdoar.com/oauthlogin_orignal/facebook_login.php';
