					...
					<div class="row">
						<div class="col-md-12">
												...
												<div class="well bgreen">
													...
													<p>
														 <?php 
															...
															echo 'Order Placed: '.'<b>'.date('d-m-Y h:i A',strtotime($OpOrder_detail[0]['order_verify_date'])).'</b>'; 
								  ...
								  <div class="col-md-12">
									<div class="table-responsive">
										<table class="table table-bordered">
										  ...
										  echo '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Discount (10%)</td><td align="right"><i class="fa fa-inr"></i> '.'<b>'.$OpOrder_detail[0]['order_discount'].'</b>'.'</td></tr>';

											if($OpOrder_detail[0]['extra_charges'] > 0)
													echo '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><i class="fa fa-inr"></i> 200 Minimum, Remaining Charges</td><td align="right"><i class="fa fa-inr"></i> '.'<b>'.$OpOrder_detail[0]['extra_charges'].'</b>'.'</td></tr>';
							...
							<div id="acceptModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								...
								<form action="accept_order.php" method="POST" id="frm_accept_order" name="frm_accept_order">
