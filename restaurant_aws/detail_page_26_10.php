...
<!-- Restaurant Close  modal popup-->   
	...
	<!-- <a href="#0" data-toggle="modal" data-target="#chk_login_session"  id="chk_login" ></a>

	<div class="modal fade" id="chk_login_session" tabindex="-1" role="dialog" aria-labelledby="addCharges" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
				<a href="#" class="close-link" id="close_login_session" data-dismiss="modal"><i class="icon_close_alt2"></i></a>
	...
	{ 
		...
		else
		{
			...
			if(email_id.length <=0 ||  mobile_number.length <=0 ||  login_tag.length <=0 ||  login_verified.length <=0)
			{
				...
				//$( "#guest2a" ).trigger( "click" );
				$( "#login_2a" ).trigger( "click" );
			}
			else
			{
				window.name="";
